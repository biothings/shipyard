...
export default function (data: Object) {
  const payload: string = kuzudbFloatingPredicateQuery(graphDB, __ENV.NUM_SAMPLE);
...
export function handleSummary(data) {
  return { "/testoutput/floating-predicate.kuzudb.su08.ts.json": JSON.stringify(data) };
}
